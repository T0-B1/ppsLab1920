...
import AlessiaCerami.u04.Lists.List.Cons
...
object Streams extends App {
  ...
  object Stream {
    ...
    def fromList[A](l:Lists.List[A], stream:Streams.Stream[A] = empty[A]()):Streams.Stream[A] = l match {
      case Lists.List.Cons(h,t) => fromList(t, Streams.Stream.Cons(() => h, () => stream))
      case _ => stream
    }
